...
if __name__ == '__main__':
    ...
    # 用于可视化
    slope_map = dem_utils.Slope_torch(pixel_size=hr_res)
    ...
    # dem_utils.write_dem(sr_dem_np,"sr.TIF")


    # 1,H*W,2
    # dx,dy
    # 自动求导计算得到的偏导数
    sr_grad_dydx= utils.gradient(sr_value, coord_grad, grad_outputs=torch.ones_like(model_out))
    # 2/64 坐标缩放
    sr_grad_dydx=2/64*sr_grad_dydx*1/hr_res
